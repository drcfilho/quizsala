...
Contexto estratégico e visual completo em [`docs/PRODUCT.md`](docs/PRODUCT.md) e [`docs/DESIGN.md`](docs/DESIGN.md) — leia antes de qualquer mudança de UI.
...
- **Nunca:** parecer app de gamificação educacional (Kahoot/Duolingo) — sem confete, mascote ou ranking de tempo de resposta, decisão já travada em `docs/arquitetura.md` §13.
