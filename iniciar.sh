...
echo " ---------------------------------------------------"
echo " O projetor abre mostrando a tela de espera (QR Code) ate"
echo " voce clicar 'Iniciar prova' no controle do professor -"
echo " o link com o codigo e o token fica em admin/index.php."
echo "==================================================="
echo ""
